...
public class AdvanceGraph extends JPanel {
   ...
   public AdvanceGraph(List<Integer> value) {
      this.Value = value;
   }
   ...
   private static void CreateGraph() {
      ...
      AdvanceGraph mainPanel = new AdvanceGraph(values);

      JFrame frame = new JFrame("AdvanceGraph");
